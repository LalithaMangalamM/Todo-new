...
const TaskModal = ({setShowEditTaskModal, taskIdforEdit}) => {
  ...
  return (
    <>
    <div onClick={handleCancel} className='bg-[#161622] opacity-[.85] absolute top-0 h-[95vh] flex justify-center items-center w-full z-[2] ' >
    ...
    <div className='bg-[#191920] absolute mx-auto top-[30%] z-[10] py-10 px-10 sm:px-20 rounded-2xl border-[1px] border-[#A6B2BC]'>
       <div>
        ...
        <div className='flex text-white justify-end gap-3 mt-2 text-[14px] sm:text-[18px]'>
            ...
            <button onClick={handleCancel} className='px-6 py-1 rounded-lg bg-[#87898b] duration-200 ease-in-out hover:bg-[#363637]'>
                Cancel
            </button>
        </div>
       </div>
